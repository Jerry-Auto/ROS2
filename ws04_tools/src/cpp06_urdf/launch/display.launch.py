...
def generate_launch_description():
    ...
    default_rviz_path = os.path.join(cpp06_urdf_dir,"rviz","urdf.rviz")       #rviz配置文件路径
    ...
    rviz2 = Node(
        package="rviz2",
        executable="rviz2",
        arguments=["-d", default_rviz_path]  #配置文件路径
    )
