...
static rosidl_typesupport_introspection_c__MessageMember base_interfaces_demo__srv__AddInts_Request__rosidl_typesupport_introspection_c__AddInts_Request_message_member_array[3] = {
  {
    "num1",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(base_interfaces_demo__srv__AddInts_Request, num3),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static rosidl_typesupport_introspection_c__MessageMember base_interfaces_demo__srv__AddInts_Response__rosidl_typesupport_introspection_c__AddInts_Response_message_member_array[2] = {
  {
    "sum",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_INT32,  // type
    0,  // upper bound of string
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(base_interfaces_demo__srv__AddInts_Response, average),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
