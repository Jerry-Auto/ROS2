...
class Init_AddInts_Request_num3
{
public:
  explicit Init_AddInts_Request_num3(::base_interfaces_demo::srv::AddInts_Request & msg)
  : msg_(msg)
  {}
  ::base_interfaces_demo::srv::AddInts_Request num3(::base_interfaces_demo::srv::AddInts_Request::_num3_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_AddInts_Request_num3 num2(::base_interfaces_demo::srv::AddInts_Request::_num2_type arg)
  {
    msg_.num2 = std::move(arg);
    return Init_AddInts_Request_num3(msg_);
  }
...
class Init_AddInts_Response_average
{
public:
  explicit Init_AddInts_Response_average(::base_interfaces_demo::srv::AddInts_Response & msg)
  : msg_(msg)
  {}
  ::base_interfaces_demo::srv::AddInts_Response average(::base_interfaces_demo::srv::AddInts_Response::_average_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_AddInts_Response_average sum(::base_interfaces_demo::srv::AddInts_Response::_sum_type arg)
  {
    msg_.sum = std::move(arg);
    return Init_AddInts_Response_average(msg_);
  }
